import { Shield, CheckCircle2, BarChart3, Clock, AlertCircle } from 'lucide-react';
      ...
      <div className="container mx-auto px-6 lg:px-12">
        ...
        <div className="max-w-4xl mx-auto mb-24">
          ...
          <div className="space-y-6 font-body text-base text-cream-muted leading-relaxed mb-12">
            <p>
              Our service delivery is supported by a real-time software technology that provides full visibility across all sites at all times.
            </p>
            <p>
              Through our software, we plan, deliver, and verify services with complete transparency, ensuring accountability and consistency at every level.
            </p>
          </div>
